...
import com.leogmag.bff_agendador_tarefas.business.TarefasService;
...
import com.leogmag.bff_agendador_tarefas.infrastructure.security.SecurityConfig;
...
public class TarefasController {
    ...
    @PostMapping
    @Operation(summary = "Salvar Tarefas de Usuários", description= "Cria uma nova tarefas")
    ...
    public ResponseEntity<List<TarefasDTOResponse>> buscaListaDeTarefasPorPeriodo(
        ...
        return ResponseEntity.ok(tarefasService.buscaTarefasAgendadasPorPeriodo(dataInicio,dataFinal, token));
    }
    ...
    @ApiResponse(responseCode = "403", description = "Tarefas não cadastradas")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    @ApiResponse(responseCode = "401", description = "Usuário não autorizado")
